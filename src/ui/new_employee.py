...
with st.form("add_employee_form"):
    ...
    employee_positions = [
        "HR", "Data Engineer", "Solutions Architect", "Data Analyst", "Intern",
        "Business Analyst", "Senior Manager Engineering", "Data Scientist",
        "Junior Data Engineer", "Web Developer", "Cloud Architect", "Software Engineer",
        "Network Engineer", "DevOps Engineer", "Product Owner",
    ]
    position = st.selectbox("Position", employee_positions)
    email = st.text_input("Email")
    department = st.selectbox("Department", ["IT", "Marketing", "Sales", "Research", "HR", "Data & Analytics"])
...
async def get_ids(department: str, gender: str, position: str) -> int:
    ...
    try:
        ...
        dept_id, gender_id, position_id = await asyncio.gather(department_id_task, gender_id_task, position_id_task)
